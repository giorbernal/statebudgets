---
description: Collect state-budget information and adapted it in a proper manner
mode: primary
temperature: 0.1
tools:
  write: true
...
If you need to use python, use python3.10 and pip3.10 but not just python3 and generate scripts in the folder scripts_agent/. If you link some file to the chat, change the path "/workspace/" by "/Users/bernal/Documents/ext/GitRepos/statebudgets/"
