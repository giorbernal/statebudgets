...
* Creamos un fichero "spendings.csv" (lo borramos si ya existe).
...
* Entraremos en cada una de las secciones y buscaremos "Presupuesto por programas" -> "Resumen económico por programas del presupuesto de gastos", trantando de buscar el .html que define este punto.
  * De cada fichero que allí encontremos (En esta ruta puedes ver un ejemplo: /pge/2024/PGE-ROM/doc/HTM/N_23P_E_R_31_107_1_1_3_1.HTM), queremos volcar en spendings.csv tantas filas como filas aparezcan con un valor en la columna "Clasif. por programas", en cada fila solo incluiremos los dos primeros campos y el último, aquí tenemos un ejemplo de cómo quedarían las filas en este fichero:
  ```
